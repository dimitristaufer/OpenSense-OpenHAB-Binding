 ...
 */
package org.eclipse.smarthome.binding.opensensenetwork;
...
/**
 * Test cases for {@link OpenSenseNetworkHandler}.
 *
 * @author ISE - Initial contribution
 */
public class OpenSenseNetworkOSGiTest extends JavaOSGiTest {

    private static final ThingTypeUID BRIDGE_THING_TYPE_UID = new ThingTypeUID("opensensenetwork", "bridge");
    ...
    @Test
    public void creationOfOpenSenseNetworkHandler() {
